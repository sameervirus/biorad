  ...
  <div class="flex">
    ...
    <div class="w-full lg:w-2/5 min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-24">
      <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-4 bg-white rounded-lg border border-solid border-gray-200 overflow-hidden" @submit.prevent="sendemail">
          <div class="px-6 py-6">
            ...
            <text-input v-model="form.email" :error="form.errors.email" class="mt-4" label="Email" type="email" autofocus autocapitalize="off" />

            <div class="flex justify-center mt-3">
              <loading-button :loading="form.processing" class="btn-greens py-8" type="submit"> Email Password Reset Link </loading-button>
            </div>
          </div>
        </form>
      </div>
